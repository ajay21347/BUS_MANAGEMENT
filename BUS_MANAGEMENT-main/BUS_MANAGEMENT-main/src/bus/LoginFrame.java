...
public class LoginFrame extends JFrame {
	...
	private boolean isValidUser(String user, String pass) {
		try (BufferedReader br = new BufferedReader(new FileReader("BUS_MANAGEMENT-main/src/bus/user.txt"))) {
			String line;
	...
	public String toString() {
		return "LoginFrame [usernameField=" + usernameField + ", passwordField=" + passwordField + "]";
	}
}
...
class RegisterFrame extends JFrame {
	public RegisterFrame() {
		...
		registerBtn.addActionListener(e -> {
			...
			try (BufferedWriter writer = new BufferedWriter(new FileWriter("BUS_MANAGEMENT-main/src/bus/user.txt", true))) {
